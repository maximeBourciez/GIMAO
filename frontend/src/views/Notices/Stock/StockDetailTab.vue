<template>
  <v-container class="doc-page">
    ...
    <div class="text-body-2 mb-4 mt-2">
      En cliquant sur une pièce spécifique depuis la liste des stocks, vous accédez à sa <strong>fiche détaillée</strong>. Cette fiche centralise les informations essentielles à la gestion de la pièce.
      <br /><br />

      <strong>Contenu de la fiche d'un consommable :</strong>
      <ul class="ml-4 mt-2 mb-4">
        <li><strong>Section Informations :</strong> récapitule les données globales comme le nom du consommable, le seuil de stock faible pour les alertes, ainsi que la quantité totale disponible.</li>
