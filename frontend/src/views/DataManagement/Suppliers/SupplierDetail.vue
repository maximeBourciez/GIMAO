<template>
  <BaseDetailView :data="supplierData" :loading="isLoading" :error-message="errorMessage"
    :title="'Détail du fournisseur'" :success-message="successMessage" :auto-display="false"
      ...
      <v-row v-else>
        <v-col>
          <v-alert type="info" outlined>
            Aucune donnée disponible pour ce fournisseur.
          </v-alert>
        </v-col>
      </v-row>
    </template>
