<template>
    <v-container>
        ...
        <v-row v-else-if="manufacturerData">
            <v-col cols="12">
                <BaseForm title="Modifier le fabricant" :loading="isSaving" :error-message="saveErrorMessage"
                    ...
                    <template #default>
                        ...
                        <v-sheet class="pa-4 mb-4" elevation="1" rounded>
                            ...
                            <v-row dense>
                                <v-col cols="12" md="6">
                                    <v-text-field v-model="manufacturerData.nom" label="Nom du fabricant *" outlined dense
                                        :rules="[v => !!v && !!v.trim() || 'Le nom du fabricant est requis']" />
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field v-model="manufacturerData.email" label="Email *" outlined dense
                                        :rules="[v => !v || isValidEmail(v) || 'Email invalide']" />
                                </v-col>
                            </v-row>
                            <v-row dense>
                                <v-col cols="6">
                                    <v-text-field v-model="manufacturerData.numTelephone" label="Téléphone *" outlined dense
                                        :rules="[v => !v || isValidPhone(v) || 'Téléphone invalide']" />
                                </v-col>
                                <v-col cols="6" class="d-flex align-center">
                                    <v-checkbox v-model="manufacturerData.serviceApresVente" label="Service après-vente"
                                        dense />
                                </v-col>
                            </v-row>
                        </v-sheet>
                        ...
                        <v-sheet class="pa-4" elevation="1" rounded>
                            ...
                            <v-row dense>
                                <v-col cols="4">
                                    <v-text-field v-model="manufacturerData.adresse.numero" label="N° *" outlined dense />
                                </v-col>
                                <v-col cols="8">
                                    <v-text-field v-model="manufacturerData.adresse.rue" label="Rue *" outlined dense
                                        :rules="[v => !v || v.trim().length >= 2 || 'La rue doit contenir au moins 2 caractères']" />
                                </v-col>
                            </v-row>
                            <v-row dense>
                                <v-col cols="6">
                                    <v-text-field v-model="manufacturerData.adresse.code_postal" label="Code postal *"
                                        outlined dense
                                        :rules="[v => !v || isValidPostalCode(v) || 'Code postal invalide']" />
                                </v-col>
                                <v-col cols="6">
                                    <v-text-field v-model="manufacturerData.adresse.ville" label="Ville *" outlined dense
                            ...
                            <v-row dense>
                                <v-col cols="12">
                                    <v-text-field v-model="manufacturerData.adresse.pays" label="Pays *" outlined dense
                                        :rules="[v => !v || v.trim().length >= 2 || 'Le pays doit contenir au moins 2 caractères']" />
                                </v-col>
                            </v-row>
                            <v-row dense>
                                <v-col cols="12">
                                    <v-text-field v-model="manufacturerData.adresse.complement" label="Complément" outlined
                                        dense />
                                </v-col>
                            </v-row>
                        </v-sheet>
