        ...
        <v-row dense>
          <v-col cols="12" md="6">
            <v-text-field
              ...
              :error-messages="
                submitted && !fabricant.nom.trim() ? 'Le nom du fabricant est requis' : ''
              "
            />
          </v-col>
          <v-col cols="12" md="6">
            <v-text-field
              ...
              :error-messages="
                submitted && fabricant.email && !isValidEmail(fabricant.email)
                  ? 'Email invalide'
                  : ''
              "
            />
        ...
        <v-row dense>
          <v-col cols="6">
            <v-text-field
              ...
              :error="
                submitted &&
                fabricant.numTelephone &&
                !isValidPhone(fabricant.numTelephone)
              "
              :error-messages="
                submitted &&
                fabricant.numTelephone &&
        ...
        <v-row dense>
          ...
          <v-col cols="8">
            <v-text-field
              ...
              :error-messages="
                submitted && adresse.rue && adresse.rue.trim().length < 2
        ...
        <v-row dense>
          <v-col cols="6">
            <v-text-field
              ...
              :error-messages="
                submitted && adresse.ville && adresse.ville.trim().length < 2
          ...
          <v-col cols="6">
            <v-text-field
              ...
              :error="
                submitted &&
                adresse.code_postal &&
                !isValidPostalCode(adresse.code_postal)
              "
              :error-messages="
                submitted &&
                adresse.code_postal &&
        ...
        <v-row dense>
          <v-col cols="12">
            <v-text-field
              ...
              :error-messages="
                submitted && adresse.pays && adresse.pays.trim().length < 2
