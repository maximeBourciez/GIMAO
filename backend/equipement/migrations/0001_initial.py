    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='Général', help_text='Type du compteur', max_length=25)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('numSerie', models.CharField(blank=True, help_text="Numéro de série de l'équipement", max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('derniereIntervention', models.IntegerField(default=0, help_text='Valeur du compteur à la dernière intervention')),
                ...
                ('compteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='declenchements', to='equipement.compteur')),
            ],
            options={
                'verbose_name': 'Seuil',
